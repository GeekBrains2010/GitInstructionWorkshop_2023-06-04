...
это репозиторий, который находится на сайте или определенной платформе удаленно от локального. Чтобы работать в удаленном репозиторие, нужен только доступ выхода в интернет.
