...
На GitHub для внесения изменений есть модель **"Fork + Pull"**.  Она позволяет подключиться к какому-либо Open Source проекту и вносить улучшение в него. Вышеуказанная модель заключается в том, что вы можете склонировать любой репозиторий к себе и разрабатывать свои изменения, после этого вы можете отправить запрос с ними автору изначального репозитория. 

Алгоритм создания pull request: 

1. Сначала нам необходимо склонировать изначальный репозиторий. Для этого перейдем к нему и нажмем кнопку **Fork**. Выбрать, скопировать только ветку main или все ветки.
2. Далее склонированный репозиторий нужно скачать на свой компьютер с помощью команды **git clone**. 
3. Создать в репозитории новую ветку, в ней создать файл README с описанием работы.
4. Работать над всеми изменениями только в этой ветке. Закоммитить изменения.
5. Отправить изменения на свой аккаунт с помощью команды **Push**.
6. На сайте Github отправить свой pull request с изменениями. 

В правом верхнем углу экрана находится кнопка Fork. Она позволяет сделать копию внешнего репозитория: ![Illustration on this project]([IMG/01.jpg](https://github.com/Niapa/GitInstructionWorkshop_2023-06-04/blob/Niapa-patch-2/IMG/01.jpg)

На странице редакирования пулл реквеста можно указать справа налево с какой ветки нужно отправить пулл реквест на какую ветку проекта: ![Illustration on this project1](https://github.com/Niapa/GitInstructionWorkshop_2023-06-04/blob/Niapa-patch-2/IMG/02.jpg)
В Github можно отслеживать информацию об изменениях пулл реквеста, его состоянии, также его можно прокомментировать или закрыть. Можно подключить синхронизацию пулл реквеста с помощью кнопки **Sync Fork**.
