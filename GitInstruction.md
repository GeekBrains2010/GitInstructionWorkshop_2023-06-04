...
Контоль версий (контроль исходного кода) - это практика, которая позволяет отслеживать изменения исходного кода и управлять им!
Система контроля версий нужна, чтобы хранить и возвращаться к разным версиям проекта.
...
Для реализации локальных и удаленных проэктов (репозиториев).
...
git config --global user.name + ваше имя__ после установки необходимо представится контролю версий.

git config --global user.email + ваша почта__ после установки необходимо указать вашу почту.

## Создание и базовая работа с локальным репозиторием.

Создаем папку с проэктом. Открываем ее в Visual Studio Code. вводим команду:
git init - инициализация, создаем репозиторий в указанной папке, в которой git начнет отслеживать изменения.
Далее создаем файл с названием проэкта и расширением (.md), например: Proekt.md
