...
В правом верхнем углу экрана находится кнопка Fork. Она позволяет сделать копию внешнего репозитория: ![Illustration on this project](01.jpg)

На странице редакирования пулл реквеста можно указать справа налево с какой ветки нужно отправить пулл реквест на какую ветку проекта: ![Illustration on this project1](02.jpg)
